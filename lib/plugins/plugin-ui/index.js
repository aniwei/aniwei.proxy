...
module.exports = function (pluginsManager) {
  var plugin  = new pluginsManager.Plugin('ui', __dirname, '0.0.1'),
  ...
  if (!plugin.get('list-settings')) {
    plugin.set('list-settings', reader(path.join(__dirname, '.uirc')));
  }
