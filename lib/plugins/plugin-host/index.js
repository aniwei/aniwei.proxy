...
module.exports = function (pluginsManager) {
  ...
  plugin.defaultSettings  = {
    ...
    path: '/etc/hosts',
    navigations: [
      { key: 'rules', icon: 'ti-layout-list-thumb', text: '规则配置', action: 'RULES' },
      { key: 'setting', icon: 'ti-settings', text: '插件设置', action: 'SETTINGS' },
      { key: 'help', icon: 'ti-help-alt', text: '使用帮助', action: 'HELPFUL' }
    ]
  };
